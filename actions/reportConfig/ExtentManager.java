...
public class ExtentManager {
	...
	public synchronized static ExtentReports createExtentReports() {
		ExtentSparkReporter reporter = new ExtentSparkReporter(GlobalConstants.RELATIVE_PROJECT_PATH  + "/extentReportV5/ExtentReportV5.html");
		...
		extentReports.setSystemInfo("Team", "NopCommcer Automation Team");
