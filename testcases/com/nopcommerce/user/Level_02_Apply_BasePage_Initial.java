...
public class Level_02_Apply_BasePage_Initial {
	...
	public void Register_02_Invalid_Email() {
		...
		basePage.sendkeyToElement(driver, "//input[@id='Email']","abc@123@gmail.com");
	...
	public void Register_03_Invalid_Password() {
		...
		basePage.sendkeyToElement(driver, "//input[@id='FirstName']", "John");
		basePage.sendkeyToElement(driver, "//input[@id='LastName']","Wick");
		basePage.sendkeyToElement(driver, "//input[@id='Email']","John123@gmail.com");
	...
	public void Register_04_Incorect_Confirm_Password() {
		...
		basePage.sendkeyToElement(driver, "//input[@id='ConfirmPassword']","123789");
